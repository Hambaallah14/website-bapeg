...
@section('dashboard-content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah Alur Kenaikan Pangkat</h1>
    </div>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="row d-flex justify-content-center">
                <div class="col-lg-8">
                    <form action="/main-dashboard/layanan/kenaikan-pangkat" method="post" enctype="multipart/form-data">
                        @csrf
