    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="row d-flex justify-content-center">
                <div class="col-lg-8">
                    <form action="/main-dashboard/profil/struktur-organisasi/<?=$struktur[0]["id"];?>" method="post" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                <img class="imagePreview img-fluid img-thumbnail" src="{{ asset('storage') }}/<?=$struktur[0]["images"]?>">
                            </div>
                            <div class="col-md-9 mb-3">
                                <div class="custom-file">
                                    <input type="hidden" name="oldFile" value="{{ $struktur[0]["images"] }}">
