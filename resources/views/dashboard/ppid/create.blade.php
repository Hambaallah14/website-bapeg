...
@section('dashboard-content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Create PPID</h1>
    </div>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="row d-flex justify-content-center">
                <div class="col-lg-8">
                    <form action="/main-dashboard/informasi/ppid" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                <img class="filePreview img-fluid img-thumbnail">
                            </div>
                            <div class="col-md-9 mb-3">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input @error('files') is-invalid @enderror" id="files" name="files" value="{{ old('files') }}" onchange="previewFile()">
